...
// Resolve the scrml compiler relative to this bridge: 6nz/src/playground-eight/bridge.js
...
const server = Bun.serve({
    ...
    fetch(req, srv) {
        ...
        return new Response("playground-eight bridge — connect via WebSocket", { status: 200 });
    },
    websocket: {
        open(socket) {
